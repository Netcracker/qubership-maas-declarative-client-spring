[![Maven build](https://github.com/Netcracker/qubership-maas-declarative-client-spring/actions/workflows/maven-deploy.yml/badge.svg)](https://github.com/Netcracker/qubership-maas-declarative-client-spring/actions/workflows/maven-deploy.yml)
